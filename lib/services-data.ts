...
export const servicesData: ServiceData[] = [
  {
    ...
    process: [
      { step: 1, title: "Discovery & Scoping", description: "We run a structured discovery sprint to define your users, core jobs-to-be-done, and the minimal feature set for your MVP.", duration: "1–2 weeks" },
  ...
  },
  {
    ...
    description:
      "Android is the world's most widely used mobile operating system. We build Android applications that perform flawlessly across the fragmented device landscape — from flagship to mid-range — using Kotlin and Jetpack Compose or React Native for cross-platform projects.",
    whatsIncluded: [
