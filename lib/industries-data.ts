...
export const industriesData: IndustryData[] = [
...

  {
    ...
    overview:
      "Professional services firms sell judgment, not just output — so software has to make practitioners faster without getting in the way of the expertise clients are actually paying for. A tool that adds friction or produces unreliable results is worse than no tool at all; it just erodes trust in the people who have to use it.\n\nWe've built technology for law firms, accounting practices, and consultancies with that in mind. Our matter management systems are designed around how lawyers and paralegals actually work day to day — not how a product roadmap imagined they should. Our document automation handles the real complexity legal precedent requires, and our client portals give clients the visibility they expect without creating extra risk for the firm.\n\nWe also take data sensitivity seriously — solicitor-client privilege, CPA confidentiality, and engagement confidentiality all shape how data gets stored, who can access it, and how it moves. Every platform we build for professional services clients has the access controls and audit logging those obligations require.",
    challenges: [
...

  {
    ...
    overview:
      "Real estate and construction projects generate a huge amount of information — RFIs, submittals, change orders, drawings, inspection reports, contracts, budgets — across dozens of people who all need a different view of it at a different time. Most teams manage that with a mix of email, shared drives, and spreadsheets, which is exactly how version confusion, missed accountability, and documentation gaps turn into disputes.\n\nWe build purpose-built software for real estate developers, general contractors, and property managers who've outgrown generic project management tools — deal pipeline systems for land acquisition teams, progress tracking for GCs running 20+ projects at once, tenant communication portals for property managers running thousands of units. Each one is designed around how decisions actually get made on your team, not a generic workflow someone else assumed you'd follow.\n\nThe industry is changing fast, too. Clients expect real-time project dashboards they can check from a job site on their phone. Lenders and equity partners want financial reporting they can actually read without a CFO to translate it. Permitting and inspections are moving digital. We build for where the industry is heading, not where it was ten years ago.",
    challenges: [
